...
def discord_help_page(prefix: str, page: int) -> str:
    ...
    if page == 1:
        return (
            ...
            f"`{prefix} models` - show available models and your current choice\n"
            f"`{prefix} model <id>` - switch this channel's model for you\n"
            f"Model IDs: `public`, `music`, `buggy`, `700`, `1300`, `1500`, `1600`, `ultimate`, `plus`, `pro`, `code`, `mega`\n"
