...
- Music output is pure neural generation. It has no canned lyric engine, keyword-answer table, reviewed-response layer, fallback song text, or inherited Public answer routing. The server samples and ranks multiple checkpoint-generated drafts; only lyric-layout guidance is fixed.
